...
public class MainActivity extends AppCompatActivity {
    ...
    private String url18 = "http://stcdn.shutoon.com/sttsk/QuestionFiles/20/182/Mp4/01.mp4";
    private String url19 = "http://stcdn.shutoon.com/sttsk/QuestionFiles/14/158/Mp4/01.mp4";
...
//        mVideoView.setVideoURI(Uri.parse(url18));
//        mVideoView.start();
        /** 普通播放 end **/
